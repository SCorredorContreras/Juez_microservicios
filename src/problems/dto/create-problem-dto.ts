...
export class CreateProblemDto {
    ...
    @ApiProperty({
        ...
        example: 'First line contains N (number of elements). Second line contains N space-separated integers. Third line contains the target sum.',
        required: true
    })
    @IsNotEmpty()
    @IsString()
    ...
    @ApiProperty({
        ...
        example: 'Two space-separated integers representing the indices of the elements that sum to the target.',
        required: true
    })
    @IsNotEmpty()
    @IsString()
